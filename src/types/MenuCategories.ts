...
const Categories: Category[] = [
    ...
    {index: 1, name: 'Deals and Promos', image: SlamburgerImage},
    {index: 2, name: 'Appetizers', image: SlamburgerImage},
    {index: 3, name: 'Drinks and Shakes', image: SlamburgerImage},
    {index: 4, name: 'Shareable Starters', image: SlamburgerImage},
